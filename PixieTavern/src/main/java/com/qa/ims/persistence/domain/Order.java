...
public class Order {
	...
	public Order(Long cusId, Long itemId, int amount) {
		this.setCusId(cusId);
	...
	public String toString() {
		return "Order [" + (id != null ? "id=" + id + ", " : "") + (cusId != null ? "cusId=" + cusId + ", " : "")
				...
				+ (itemName != null ? "itemName=" + itemName + ", " : "") + "itemPrice=" + itemPrice + ", amount="
				+ amount + ", confirmed=" + confirmed + ", totalCost=" + totalCost + "]";
	}
